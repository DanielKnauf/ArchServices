object Versions {
    ...
    object Android {
        const val vGradle = "7.1.3"
    }

    object AndroidX {
        const val vAppCompat = "1.4.1"
        const val vBroadcastManager = "1.1.0"
        const val vBrowser = "1.4.0"
        const val vConstraintLayout = "2.1.3"
        const val vCore = "1.7.0"
        const val vFragment = "1.4.1"
        const val vLegacySupport = "1.0.0"
        const val vLifecycle = "2.4.1"
        const val vLifecycleExtensions = "2.2.0"
        const val vNavigation = "2.5.0-alpha04"
        const val vRecyclerView = "1.2.1"
        const val vRoom = "2.4.2"
